...
CREATE TABLE `employee` (
  ...
  `amount_hours_lunch` float DEFAULT NULL,
  `amount_hours_work_day` float DEFAULT NULL,
...
CREATE TABLE `accountingEntry` (
  `id` bigint(20) NOT NULL,
  `account_entry_date` datetime NOT NULL,
  `modification_date` datetime NOT NULL,
  `creation_date` datetime NOT NULL,
...
--
-- Indexes for table `accountingEntry`
--
...
ALTER TABLE `employee`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `accountingEntry`
--
ALTER TABLE `accountingEntry`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `accountingEntry`
--
ALTER TABLE `accountingEntry`
